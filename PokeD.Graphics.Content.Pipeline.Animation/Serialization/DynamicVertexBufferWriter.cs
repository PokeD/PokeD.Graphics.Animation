...
namespace tainicom.Aether.Content.Pipeline.Serialization
{
    ...
    {    
        ...
        public override string GetRuntimeReader(TargetPlatform targetPlatform) => "tainicom.Aether.Graphics.Content.DynamicVertexBufferReader, PokeD.Graphics.Animation";
    }
}